...
public class CustomerService extends AbstractService<Customer> implements Serializable {
   ...
   protected Predicate[] getSearchPredicates(Root<Customer> root, Customer example) {
      ...
      if (firstName != null && !"".equals(firstName)) {
         predicatesList
               .add(builder.like(builder.lower(root.<String>get("firstName")), '%' + firstName.toLowerCase() + '%'));
      }
      ...
      if (telephone != null && !"".equals(telephone)) {
         predicatesList
               .add(builder.like(builder.lower(root.<String>get("telephone")), '%' + telephone.toLowerCase() + '%'));
      }
